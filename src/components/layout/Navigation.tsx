        ...
        <div className="flex items-center h-24">
          ...
          <div className="md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-[#4da8ff] hover:bg-white/5 focus:outline-none transition-all duration-300 relative z-50"
        ...
        <div className="flex flex-col min-h-screen">
            ...
            {navigation.map((item, index) => (
              <Link
                ...
                className={`
                  ...
                  ${pathname === item.href 
                    ? 'text-[#4da8ff] font-semibold bg-white/5' 
                    : 'text-white hover:text-[#4da8ff] hover:bg-white/5'}
                `}
                onClick={() => setIsOpen(false)}
                style={{
          ...
          <div className="mt-auto p-6 border-t border-gray-800/50">
            <div className="flex justify-center space-x-8">
              <a 
                href="tel:+1234567890" 
                className="text-white hover:text-[#4da8ff] transition-colors duration-300 p-2 rounded-full hover:bg-white/5"
              >
              ...
              <a 
                href="mailto:contact@cgmodeltek.com" 
                className="text-white hover:text-[#4da8ff] transition-colors duration-300 p-2 rounded-full hover:bg-white/5"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
